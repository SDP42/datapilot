...
> a deterministic structural feature inventory (6.2), and deterministic
> rule-based transformation recommendations (6.3). ML, DL, LLM, API, and
> UI functionality are **not started**. See
