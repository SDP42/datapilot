...
> `ModelingSpec` contract + foundation (7.1) and deterministic model
> readiness + data-split planning (7.2 — plans only, trains and evaluates
> nothing). Model training, DL, LLM, API, and UI functionality are **not
