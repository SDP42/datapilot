...
| **Phase 4 — EDA & Statistical Analysis** (`data_engine.eda`) | ✅ In progress — deterministic analysis-only EDA foundation + statistical hypothesis testing (Welch t-test, one-way ANOVA, chi-square) + effect sizes / association measures (Cramér's V, correlation ratio, mutual information); no rank correlation or visualization |
