...
> generation (7.3), and deterministic baseline model training & evaluation
> (7.4 — fits conservative scikit-learn baselines and reports per-candidate
> metrics; selects, ranks, and recommends nothing). Model selection, DL,
> LLM, API, and UI functionality are **not started**. See
